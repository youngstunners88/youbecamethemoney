...
- **Global scope**: `/home/teacherchris37/youbecamethemoney/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/teacherchris37/youbecamethemoney/.claude/notes/`)
...
2. Glob `/home/teacherchris37/youbecamethemoney/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/teacherchris37/youbecamethemoney/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/teacherchris37/youbecamethemoney/.claude/notes/` — works in any directory
