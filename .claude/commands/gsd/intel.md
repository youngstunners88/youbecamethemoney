...
Intel system is disabled. To activate:
  ...
  node /home/teacherchris37/youbecamethemoney/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/teacherchris37/youbecamethemoney/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/teacherchris37/youbecamethemoney/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/teacherchris37/youbecamethemoney/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /home/teacherchris37/youbecamethemoney/.claude/get-shit-done/bin/gsd-tools.cjs
