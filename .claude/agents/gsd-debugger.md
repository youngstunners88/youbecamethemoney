...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/teacherchris37/youbecamethemoney/.claude
                  → checks /home/teacherchris37/youbecamethemoney/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/teacherchris37/youbecamethemoney/.claude/get-shit-done
                  → writes to /home/teacherchris37/youbecamethemoney/.claude/get-shit-done/hooks/
...
@/home/teacherchris37/youbecamethemoney/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/teacherchris37/youbecamethemoney/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/teacherchris37/youbecamethemoney/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/teacherchris37/youbecamethemoney/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/teacherchris37/youbecamethemoney/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
