...
def create_invoice():
    ...
    invoice_data = [
        ['Invoice Number:', 'YS-2025-YBTM-001'],
        ['Date:', 'March 13, 2025'],
        ['Due Date:', 'March 27, 2025 (Net 14)'],
        ['Client:', 'Daniel Garcia / You Became The Money'],
        ['Project:', 'YBTM Website & Lead Magnet Package'],
    ]
    ...
    services_data = [
        ...
        [
            'Lead Magnet Ebook',
            '8-page illustrated PDF\n"You Became The Money: The Path to Financial Sovereignty"\nCustom chapter illustrations, 14 pages total',
            '$1,200.00'
        ],
        [
            'Website Enhancement',
    ...
    services_table = Table(services_data, colWidths=[1.8*inch, 3*inch, 1.2*inch])
    ...
    totals_table.setStyle(TableStyle([
        ...
        ('ALIGN', (0, 0), (0, -1), 'RIGHT'),
        ('ALIGN', (1, 0), (1, -1), 'RIGHT'),
        ('TEXTCOLOR', (0, 3), (-1, 3), colors.HexColor('#8B0000')),
        ('FONTSIZE', (0, 3), (-1, 3), 14),
        ('LINEABOVE', (0, 3), (-1, 3), 2, colors.HexColor('#8B0000')),
    ...
    elements.append(Spacer(1, 0.1*inch))
    elements.append(Paragraph("By signing below, the Client acknowledges acceptance of this invoice and authorizes Young Stunners to proceed with the project as described.", auth_style))
    ...
    sig_table = Table(signature_data, colWidths=[3*inch, 0.5*inch, 2*inch])
